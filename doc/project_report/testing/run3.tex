...
\subsection*{Test 1 (run 3)}
	...
	\begin{table}[htb]
		...
		\end{tabular}
		\caption{Summary of test 1 (run 3)}
	\end{table}
	...
	\begin{table}[htb]
		...
		\end{tabular}
		\caption{Execution of test 1 (run 3)}
	\end{table}
...
\subsection*{Test 2 (run 3)}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{|p{3.5cm}|p{7.0cm}|} \hline
			...
			\textbf{Result} & PASS \\ \hline
		\end{tabular}
		\caption{Summary of test 2 (run 3)}
	\end{table}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{|p{5.0cm}|p{5.0cm}|p{1cm}|}
			...
			PASS \\ \hline
		\end{tabular}
		\caption{Execution of test 2 (run 3)}
	\end{table}
...
\subsection*{Test 3 (run 3)}
	...
	\begin{table}[htb]
		...
		\end{tabular}
		\caption{Summary of test 3 (run 3)}
	\end{table}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{|p{5.0cm}|p{5.0cm}|p{1cm}|}
			...
			PASS \\ \hline
		\end{tabular}
		\caption{Execution of test 3 (run 3)}
	\end{table}
...
\subsection*{Test 4 (run 3)}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{|p{3.5cm}|p{7.0cm}|} \hline
			...
			\textbf{Result} & PASS \\ \hline
		\end{tabular}
		\caption{Summary of test 4 (run 3)}
	\end{table}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{|p{5.0cm}|p{5.0cm}|p{1cm}|}
			...
			PASS \\ \hline
		\end{tabular}
		\caption{Execution of test 4 (run 3)}
	\end{table}
...
\subsection*{Test 5 (run 3)}
	...
	\begin{table}[htb]
		...
		\end{tabular}
		\caption{Summary of test 5 (run 3)}
	\end{table}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{|p{5.0cm}|p{5.0cm}|p{1cm}|}
			...
			- \\ \hline
		\end{tabular}
		\caption{Execution of test 5 (run 3)}
	\end{table}
...
\subsection*{Test 6 (run 3)}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{|p{3.5cm}|p{7.0cm}|} \hline
			...
			\textbf{Result} & PASS \\ \hline
		\end{tabular}
		\caption{Summary of test 6 (run 3)}
	\end{table}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{|p{5.0cm}|p{5.0cm}|p{1cm}|}
			\hline \textbf{Action} & \textbf{Expected outcome} & \textbf{Result} \\ \hline
				...
				PASS \\ \hline
		\end{tabular}
		\caption{Execution of test 6 (run 3)}
	\end{table}
...
\subsection*{Test 7 (run 3)}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{|p{3.5cm}|p{7.0cm}|} \hline
			...
			\textbf{Result} & PASS \\ \hline
		\end{tabular}
		\caption{Summary of test 7 (run 3)}
	\end{table}
	...
	\begin{table}[htb]
		...
		\end{tabular}
		\caption{Execution of test 7 (run 3)}
	\end{table}
...
\subsection*{Test 8 (run 3)}
	...
	\begin{table}[htb]
		...
		\begin{tabular}{|p{3.5cm}|p{7.0cm}|} \hline
			...
			\textbf{Result} & PASS \\ \hline
		\end{tabular}
		\caption{Summary of test 8 (run 3)}
	\end{table}
	...
	\begin{table}[htb]
		...
		\end{tabular}
		\caption{Execution of test 8 (run 3)}
	\end{table}
