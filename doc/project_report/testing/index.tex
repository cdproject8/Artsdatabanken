...
\centering
 \begin{center}$
 \begin{array}{cc}
 \includegraphics[scale=0.84]{ut_pic/legenda.png} &
 \includegraphics[scale=0.8]{ut_pic/legend3.png}
...
\centering
 \begin{center}$
 \begin{array}{cc}
 \includegraphics[scale=0.8]{ut_pic/mobileapp.png}
...
\begin{figure}[htb]
    \centering
    \includegraphics[scale=0.8]{ut_pic/difficutltoinstall.png}
...
\centering
 \begin{center}$
 \begin{array}{cc}
 \includegraphics[scale=0.8]{ut_pic/easytosetup.png} &
 \includegraphics[scale=0.8]{ut_pic/hasmetmyexpectation.png} 
 \includegraphics[scale=0.8]{ut_pic/userfriendlybuttons.png}
 \end{array}$
 \end{center}
...
\begin{figure}[htb]
    \centering
    \includegraphics[scale=0.8]{ut_pic/productivityandintensiontouse.png}
    \label{Productivity and intention to use}
    \caption{Majority result showing positive result for productivity and intention to use}
\end{figure}

While all three of our participants liked the functionality New observation, each seem to have a least favorite functionality. Export, Take picture and Store observation have each on participant not favoring them.
\newpage
\begin{figure}[htb]
    \centering
