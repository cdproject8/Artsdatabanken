...
observations.  Improvements in design and functionality shouldn't be an issue,
and the potential i present.  First priorities might be the incorporation of a
direct submission API towards Artsdatabankens services, to avoid having to
export through mail and import again.  Optimizing screen use might also be an
