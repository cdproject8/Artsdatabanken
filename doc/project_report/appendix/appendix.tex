...
\centering
 \begin{center}$
 \begin{array}{cc}
 \includegraphics[width=0.6\textwidth,height=0.9\textwidth]{appendix/pic/det1.jpg} &
 \includegraphics[width=0.6\textwidth,height=0.9\textwidth]{appendix/pic/det2.jpg}
 \end{array}$
 \end{center}
...
\centering
 \begin{center}$
 \begin{array}{cc}
 \includegraphics[width=0.6\textwidth,height=0.6\textwidth]{appendix/pic/lagr1.jpg} &
 \includegraphics[width=0.6\textwidth,height=0.6\textwidth]{appendix/pic/lagr2.jpg}
 \end{array}$
 \end{center}
