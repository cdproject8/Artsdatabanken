...
\section{Project directive and templates TODO}
	...
	\subsection{Meeting agendas}
		\begin{figure}[htb]
			\centering
			\includegraphics[width=1\textwidth]{appendix/meeting_agenda.jpg}
	...
	\subsection{Meeting minutes}
		\begin{figure}[htb]
			\centering
			\includegraphics[width=1\textwidth]{appendix/meeting_minutes.jpg}
	...
	\subsection{Weekly status report}
		\begin{figure}[htb]
			\centering
			\includegraphics[width=1\textwidth]{appendix/weekly_status_report.jpg}
