...
When the user makes a selection, the selected button becomes blue and the user is sure that he pressed the right button.
...
After selecting New Observation, the page transitions into the window displayed in figure~\ref{fig:observation}. Here he selects the Species. 
Their names are displayed, with pictures on the side. More species are listed; the user needs to slide his finger to see those.
...
The user can fill the fields easily by selecting the field he wants to fill. The selected field is marked with a blue shadow so the user knows which field is selected.
...
There are several buttons here for the user. If he wants to add more information about the species, the “Add More Information” button is selected. 
...
If the user wants to add new species he selects the “Add another species” button. This gives a new row in the same window, by adding new species the window increases its height. The user needs to slide vertically if many more species are added.
