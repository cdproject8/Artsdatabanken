...
Figure~\ref{fig:mainscreen} shows the main screen of the application. The buttons are clear and the user can simply do a selection
When the user makes a selection, the selected button becomes blue and the user is sure he pressed the right button.
