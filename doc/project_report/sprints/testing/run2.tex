...
\subsubsection{Test 5 (run 2)}
	...
	\begin{figure}[htb]
		...
		\begin{tabular}{|p{3.5cm}|p{7.0cm}|} \hline
			...
			\textbf{Comments} & Can choose from earlier taken/saved photos, cant take a new picture.   \\ \hline
		\end{tabular}
