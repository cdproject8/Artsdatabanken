...
\subsection{Implementation}
	...
	provided by Artsdatabanken. This required us to change some URL's, use
	literal names instead of ID's. Using literal names was a bit problematic as
	Artsdatabanken is including some special characters in the literal names that
	are not actually supported by the API (using commas in a request cause the API
