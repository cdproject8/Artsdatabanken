\subsection{Development process}
	...
	\begin{figure}[htb]
		\centering
		\includegraphics[width=0.8\textwidth]{organizational/development_process/scrum.png}
	...
	For this project, team decided to use SCRUM model. But as SCRUM requires strict and precise following of the predefined model, actual development process will be slightly modified. Project will have 4 sprints, including additional 'zero' sprint, and each sprint will be finished during 2 weeks, or 10 working days. Additional time will be left after competition of the sprints for revision, fixing and more testing, to make product better and more reliable.
