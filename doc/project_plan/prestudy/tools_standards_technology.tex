...
The MOWAHS, MObile Work Across Heterogeneous Systems, a specialized technique to analyze gathered requirements for mobile work scenario.  The framework has three levels of operation eliciting scenarios, scenario analysis and requirement analysis.\cite{wiki:MOWAHS}
